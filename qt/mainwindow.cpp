	...
	QMainWindow(parent), cuda_thread(NULL), ui(new Ui::MainWindow)
{
	...
	connect(ui->aabb_checkbox, SIGNAL(toggled(bool)), this, SLOT(aabb_checkbox_stateChanged(bool)));
	connect(ui->prev_checkbox, SIGNAL(toggled(bool)), this, SLOT(prev_checkbox_stateChanged(bool)));
	connect(ui->norm_checkbox, SIGNAL(toggled(bool)), this, SLOT(norm_checkbox_stateChanged(bool)));
...
void MainWindow::aabb_checkbox_stateChanged(bool checked)
{
	sceneState.toggleAABBmode(checked);
}

void MainWindow::prev_checkbox_stateChanged(bool checked)
{
	sceneState.togglePrevMode(checked);
}

void MainWindow::norm_checkbox_stateChanged(bool checked)
{
	if (checked) {
